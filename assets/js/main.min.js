...
function featured(){"use strict";$(".featured-posts").owlCarousel({dots:!1,margin:30,nav:!0,navText:['<i class="icon icon-chevron-left"></i>','<i class="icon icon-chevron-right"></i>'],responsive:{0:{items:1},768:{items:3},992:{items:4}}})}function gallery(){"use strict";document.querySelectorAll(".kg-gallery-image img").forEach(function(e){var i=e.closest(".kg-gallery-image"),t=e.attributes.width.value/e.attributes.height.value;i.style.flex=t+" 1 0%"})}function social(){"use strict";var e={facebook:{name:"Facebook",icon:"facebook"},twitter:{name:"Twitter",icon:"twitter"},instagram:{name:"Instagram",icon:"instagram"},dribbble:{name:"Dribbble",icon:"dribbble"},behance:{name:"Behance",icon:"behance"},github:{name:"GitHub",icon:"github-circle"},linkedin:{name:"LinkedIn",icon:"linkedin"},vk:{name:"VK",icon:"vk"},rss:{name:"RSS",icon:"rss"}},i=themeOptions.social_links,t="";for(var n in i)""!=i[n]&&(t+='<a class="footer-social-item" href="'+i[n]+'" target="_blank"><i class="icon icon-'+e[n].icon+'"></i></a>');$(".footer-social").html(t)}function copyright(){"use strict";""!=themeOptions.copyright&&$(".copyright").html(themeOptions.copyright)}function mobileMenu(){"use strict";$(".burger").on("click",function(){$("body").toggleClass("menu-opened")})}$(function(){"use strict";featured(),gallery(),social(),copyright(),mobileMenu()}),document.addEventListener("lazyloaded",function(e){"use strict";$(e.target).parent(".site-cover").length&&$(e.target).parent().jarallax({disableParallax:/iPad|iPhone|iPod|Android/,disableVideo:/iPad|iPhone|iPod|Android/,speed:.1}).addClass("initialized")});